set title "Direcc. Asintóticas para Marambio"
unset key
set grid
unset yzeroaxis
#
...
FILE='./AsymDirec_ZEN15.dat'
repl FILE index 0 u 4:3 with linespoints pt 7 lt rgb "black" ti "100GV"
repl FILE index 1 u 4:3 with linespoints pt 7 lt rgb "red" ti "80GV"
repl FILE index 2 u 4:3 with linespoints pt 7 lt rgb "dark-green" ti "50GV"
repl FILE index 3 u 4:3 with linespoints pt 7 lt rgb "dark-orange" ti "30GV"
repl FILE index 4 u 4:3 with linespoints pt 7 lt rgb "dark-blue" ti "20GV"
