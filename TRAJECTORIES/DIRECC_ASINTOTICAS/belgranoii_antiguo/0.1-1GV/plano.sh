...
FILE='./AsymDirec_ZEN15_.dat'
repl FILE index 0 u 4:3 with linespoints pt 7 lt rgb "red" ti "1GV"
repl FILE index 1 u 4:3 with linespoints pt 7 lt rgb "dark-red" ti "0.7GV"
repl FILE index 2 u 4:3 with linespoints pt 7 lt rgb "dark-green" ti "0.6GV"
repl FILE index 3 u 4:3 with linespoints pt 7 lt rgb "orange" ti "0.5GV"
#repl FILE index 4 u 4:3 with linespoints pt 7 lt rgb "dark-blue" ti "--GV"
