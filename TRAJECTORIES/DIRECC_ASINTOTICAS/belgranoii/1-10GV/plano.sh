...
repl FILE index 2 u 4:3 with linespoints pt 7 lt rgb "dark-green" ti "4GV"
repl FILE index 3 u 4:3 with linespoints pt 7 lt rgb "orange" ti "3GV"
repl FILE index 4 u 4:3 with linespoints pt 7 lt rgb "dark-blue" ti "2GV"
repl FILE index 5 u 4:3 with linespoints pt 7 lt rgb "black" ti "--GV"
