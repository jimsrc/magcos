...
################################################################
FILE='./malarg_and_rome_asym_zen30.data'
...
repl FILE index 1 u 4:3 with linespoints pt 2 lt rgb "red" ti ""
repl FILE index 2 u 4:3 with linespoints pt 3 lt rgb "orange" ti ""
repl FILE index 3 u 4:3 with linespoints pt 5 lt rgb "dark-blue" ti ""
...
repl FILE index 5 u 4:3 with linespoints pt 2 lt rgb "red" ti "50GV"
repl FILE index 6 u 4:3 with linespoints pt 3 lt rgb "orange" ti "30GV"
repl FILE index 7 u 4:3 with linespoints pt 5 lt rgb "dark-blue" ti "20GV"
