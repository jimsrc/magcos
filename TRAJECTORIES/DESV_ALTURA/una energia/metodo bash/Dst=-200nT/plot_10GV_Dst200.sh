...
set macros
#
set xlabel "Longitude" font "Arial,13"
set ylabel "Latitude" font "Arial,13"
set zlabel "Height [Re]" font "Arial,13"
set cblabel "Height [Re]" font "Arial,13"
set zlabel rotate by 90
#
altura = "(sqrt($3*$3+$4*$4+$5*$5)-1)"
#plot 'world.dat' with lines lt 3 ti ""
spl './10GV_dst=0_dat' u 2:1:(@altura) pt 7 ti 'Dst=0nT'
repl './10GV_dst=-200_dat' u 2:1:(@altura) pt 7 ti 'Dst=-200nT'
repl './10GV_dst=-400_dat' u 2:1:(@altura) pt 7 ti 'Dst=-400nT'
...
repl './10GV_dst=0_dat' u 2:1:(0):(@altura) pt 6 lt pal noti
repl './10GV_dst=-200_dat' u 2:1:(0):(@altura) pt 6 lt pal noti
repl './10GV_dst=-400_dat' u 2:1:(0):(@altura) pt 6 lt pal noti
