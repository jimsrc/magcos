...
set xrange [ * : * ] noreverse nowriteback  # (currently [1.70000:2.40000] )
set x2range [ * : * ] noreverse nowriteback  # (currently [1.71000:2.40000] )
set ylabel "Transmitancia" 
...
GNUTERM = "wxt"
pl './penumbra.out' u 1:(1-$2) with boxes fs solid noti
#    EOF
