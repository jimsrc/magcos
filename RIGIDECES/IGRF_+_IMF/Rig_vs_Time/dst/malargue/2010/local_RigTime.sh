...
set key left bottom
pl [0:24] [8.31:9.25] './local_dst0.dat' u ($1/3600):3 with linespoints pt 1 ti "        Dst=0nT"
...
repl './local_dst600.dat' u ($1/3600):3 w lp pt 6 ti "Dst=-600nT"
