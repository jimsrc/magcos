...
dst500=dlmread('local_dst500.dat', '', 3, 0);
%
col_time=1;
col_Ru=2;
col_Rc=3;
...
dlmwrite('dst_vs_Rc_marambio.dat', '# $1 : Dst', 'delimiter', '')
dlmwrite('dst_vs_Rc_marambio.dat', '# $2 : Rc', 'delimiter', '', '-append')
dlmwrite('dst_vs_Rc_marambio.dat', '# -----Marambio', 'delimiter', '', '-append')
dlmwrite('dst_vs_Rc_marambio.dat', dst_vs_Rc, 'delimiter', ' ', '-append')
%
%%
